...
def gwas_from_data(data, extra_columns=None):
    ...
    g = pandas.DataFrame({Constants.SNP:numpy.array(rsid, dtype=numpy.str_),
                        Constants.CHROMOSOME:numpy.array(chromosome, dtype=numpy.str_),
                        Constants.POSITION:numpy.array(position),
                        Constants.EFFECT_ALLELE:numpy.array(effect_allele, dtype=numpy.str_),
                        Constants.NON_EFFECT_ALLELE:numpy.array(non_effect_allele, dtype=numpy.str_),
